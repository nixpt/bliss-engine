//! Script engine abstraction for blitz-dom
//!
//! This trait allows pluggable script execution engines to be integrated with the DOM.
//! Script engines can execute JavaScript and handle DOM events.
