...
#[derive(Clone)]
pub(crate) struct BlissFontMetricsProvider {
    pub(crate) font_ctx: Arc<Mutex<FontContext>>,
}

impl core::fmt::Debug for BlissFontMetricsProvider {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        write!(f, "BlissFontMetricsProvider")
    }
}

impl FontMetricsProvider for BlissFontMetricsProvider {
