...
// use crate::{BlissShellEvent, event::BlissShellProxy};

// /// A NetWaker that wakes up our winit event loop
// pub struct BlissShellNetWaker(BlissShellProxy);

// impl BlissShellNetWaker {
//     pub fn new(proxy: BlissShellProxy) -> Self {
//         Self(proxy)
//     }

//     pub fn shared(proxy: BlissShellProxy) -> Arc<dyn NetWaker> {
//         Arc::new(Self(proxy))
//     }
// }
// impl NetWaker for BlissShellNetWaker {
//     fn wake(&self, doc_id: usize) {
//         self.0.send_event(BlissShellEvent::RequestRedraw { doc_id })
//     }
// }

#[cfg(feature = "data-uri")]
mod data_uri_net_provider {
    //! Data-URI only networking for Bliss
    //!
    //! Provides an implementation of the [`bliss_traits::net::NetProvider`] trait.

    use bliss_traits::net::{Bytes, NetHandler, NetProvider, NetWaker, Request};
